...
- [Single dependency](https://pkg.go.dev/github.com/fortytw2/websocket?tab=imports)
- JSON helpers in the [wsjson](https://pkg.go.dev/github.com/fortytw2/websocket/wsjson)
- Zero alloc reads and writes
- Concurrent writes
- [Close handshake](https://pkg.go.dev/github.com/fortytw2/websocket#Conn.Close)
- [net.Conn](https://pkg.go.dev/github.com/fortytw2/websocket#NetConn) wrapper
- [Ping pong](https://pkg.go.dev/github.com/fortytw2/websocket#Conn.Ping) API
...
- Minimal and idiomatic API
  - Compare godoc of [github.com/fortytw2/websocket](https://pkg.go.dev/github.com/fortytw2/websocket) with [gorilla/websocket](https://pkg.go.dev/github.com/gorilla/websocket) side by side.
- [net.Conn](https://pkg.go.dev/github.com/fortytw2/websocket#NetConn) wrapper
...
- Idiomatic [ping pong](https://pkg.go.dev/github.com/fortytw2/websocket#Conn.Ping) API
  - Gorilla requires registering a pong callback before sending a Ping
- Can target Wasm ([gorilla/websocket#432](https://github.com/gorilla/websocket/issues/432))
- Transparent message buffer reuse with [wsjson](https://pkg.go.dev/github.com/fortytw2/websocket/wsjson) and [wspb](https://pkg.go.dev/github.com/fortytw2/websocket/wspb) subpackages
...
- [CloseRead](https://pkg.go.dev/github.com/fortytw2/websocket#Conn.CloseRead) helper ([gorilla/websocket#492](https://github.com/gorilla/websocket/issues/492))
...
The [net.Conn](https://pkg.go.dev/github.com/fortytw2/websocket#NetConn) can help in transitioning
to github.com/fortytw2/websocket.
